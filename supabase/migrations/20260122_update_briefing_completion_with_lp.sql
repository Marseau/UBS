-- Atualiza função de cálculo de completion para considerar LP processada
...
BEGIN
  ...
  -- Secao 2: Produto/Servico - peso 3
  total_fields := total_fields + 3;
  ...
  -- Secao 3: Diferencial (MAIS IMPORTANTE) - peso 6
  ...
  -- Secao 6: Tom de Voz e CTA - peso 2
  total_fields := total_fields + 2;
  ...
  -- Total: 22 pontos possíveis
  -- LP processada = 3 pontos (~14% do total)
