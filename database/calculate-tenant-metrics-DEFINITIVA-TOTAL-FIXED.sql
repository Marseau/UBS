...
DROP FUNCTION IF EXISTS calculate_tenant_metrics_definitiva_total(date, uuid);
DROP FUNCTION IF EXISTS run_tenant_metrics_cronjob_definitiva_total();

-- =====================================================
-- TENANT METRICS FUNCTION - DEFINITIVA TOTAL VERSION
-- Complete 73+ metrics implementation with all corrections
