-- =====================================================
-- FUNÇÃO CORRIGIDA - SEM REFERÊNCIAS AO UBS_METRIC_SYSTEM
-- =====================================================
-- Usa apenas platform_metrics e tenant_metrics existentes
-- Schema real: calculation_date, period_days, etc.
-- =====================================================
...
'Calcula métricas da plataforma usando schema real: platform_metrics (calculation_date, period_days, etc.)';

-- Testar função após criação
SELECT calculate_enhanced_platform_metrics(CURRENT_DATE, 30);

-- =====================================================
-- RESULTADO ESPERADO:
-- =====================================================
-- ✅ Função criada sem referências ao ubs_metric_system
-- ✅ Usa schema real: calculation_date, period_days
-- ✅ Popula platform_metrics com dados reais
